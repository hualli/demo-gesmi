  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="brand-link">
        <img src="{{ asset('img/logo.jpg') }}" alt="GesMI Logo" class="brand-image img-circle elevation-3">
        <span class="brand-text font-weight-light">GesMI</span>
      </div>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2021 <a href="https://indigodigital.ar" target="_blank">Indigo! Digital</a></strong>
    </footer>

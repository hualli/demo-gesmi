                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <label>Estado</label>
                      <select name="estado" id="estado" class="form-control">
                        ...
                        <option value="1" {{($usuario->estado == 'habilitado') ? "selected": ""}}>Habilitado</option>
                        <option value="2" {{($usuario->estado == 'deshabilitado') ? "selected": ""}}>Deshabilitado</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group">
                      ...
                      <select name="tipo" id="tipo" class="form-control">
                        ...
                        <option value="1" {{($usuario->tipo == 'medico') ? "selected": ""}}>M&eacute;dico</option>
                        <option value="2" {{($usuario->tipo == 'administrativo') ? "selected": ""}}>Administrativo</option>
                      </select>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group">
                      ...
                      <select name="principal" id="principal" class="form-control">
                        ...
                        <option value="1" {{($usuario->principal == 'pacientes') ? "selected": ""}}>Pacientes</option>
                        <option value="2" {{($usuario->principal == 'visor') ? "selected": ""}}>Visor</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
